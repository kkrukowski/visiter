const {
  ...
  isLoggedIn,
  isOwner,
} = require("../middlewares/authHandler"); // importuj funkcję
...
describe("isLoggedOut", () => {
  ...
  it("should render home page with appropriate message if user is authenticated", async () => {
    ...
    jest
      .spyOn(Business, "find")
      .mockReturnValueOnce({ exec: jest.fn().mockResolvedValueOnce(business) });
...
describe("isOwner", () => {
  it("should call next() if user is owner of business", async () => {
    ...
    const business = {
      ...
      ownerId: new ObjectId("63a6ddae1a83354d2702f933"),
    };
    jest
